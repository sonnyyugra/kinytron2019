...
@section('content')
    <div class="py-4">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header" align="center">Gráfico Individual de {{$usuario->name}} - Trabajo en Equipo - {{$usuario->course->getFullNameAttribute()}} - {{$medicion->created_at->format('d/m/Y')}}</div>
                    <div class="card-body">
                        <div>
