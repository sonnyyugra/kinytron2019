        ...
        <div class="row" align="center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        {!! $chart_ComunicacionAsertiva->container() !!}
                    ...
                    <div class="card-body">
                        ...
                        <table id="example"  style="width:100%" class="table table-bordered">
                            ...
                            @foreach($measurement->course->users as $user)
                                <tr>
                                    <td>
                                        <a href="{!! route('measurement.comunicacion', ['measurement'=>$measurement->id, 'user'=>$user->id]) !!}">{{$user->name}}</a>
                                    </td>
...
@endsection
{!! $chart_ComunicacionAsertiva->script() !!}