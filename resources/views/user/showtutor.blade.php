        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-hover table-striped" data-toggle="dataTable" data-form="deleteForm">
                            ...
                            @foreach($users as $user)
                                <tr>
                                    ...
                                    <th width="40px"><a href="{{ route('edittutor',['id' => $user->id]) }}" class="btn btn-warning pull-right">Editar</a></th>
                                    <th width="40px">
                                        {{ Form::open(['method' => 'DELETE', 'route' => ['deletetutor', $user],'class' => 'form-delete']) }}
                        ...
                        <!--  MODAL -->
                        <!-- EVALUCION MODAL -->
                        <div id="agregarTutor" class="modal fade" role="dialog">
                            <div class="modal-dialog">
                                <!-- Modal content-->
                                <div class="modal-content">
                                    <div class="modal-header">
            ...
            <div class="col-md-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-whatever="" data-target="#agregarTutor"><i class="fa fa-user"></i> Agregar Tutor</button>
                    </div>
                </div>
            </div>
        </div>
