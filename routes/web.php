...
Route::get('/test_autoestima', function () {
    return view('videogames.test_autoestima');
});
Route::get('/test_clima_escolar', function () {
    return view('videogames.test_clima_escolar');
});
Route::get('/historia_kinytron', function () {
    return view('videogames.historia_kinytron');
});
Route::get('/cuest_trabajo_equipo', function () {
    return view('videogames.cuest_trabajo_equipo');
});
Route::get('/cuest_com_asertiva', function () {
    return view('videogames.cuest_com_asertiva');
});
Route::get('/cuest_empatia', function () {
    return view('videogames.cuest_empatia');
});
Route::get('/cuest_disciplina', function () {
    return view('videogames.cuest_disciplina');
});
